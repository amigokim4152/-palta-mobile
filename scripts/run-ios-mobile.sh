...
# Public client configuration can be overridden by the caller. Golden User
# credentials are never defaulted here; a local development shell must opt in.
...
info "Checking public environment and Golden User development boundary..."
node "$ROOT/scripts/preflight-env.mjs"
