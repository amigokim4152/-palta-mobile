...
export const HOME_CAPABILITIES: readonly HomeCapabilityDefinition[] = [
  ...
  { key: 'today.seasonal_food', surface: 'useful_today', ownerCore: 'Knowledge/Local-Life', status: 'pending_core', demoRequired: true, description: 'Timely seasonal produce/fish/local-life information.' },
