...
export const HOME_CAPABILITIES: readonly HomeCapabilityDefinition[] = [
  ...
  { key: 'now.emergency_alert', surface: 'now', ownerCore: 'Safety/Event', status: 'pending_core', demoRequired: true, description: 'Verified emergency/disaster alert affecting the user.' },
  { key: 'now.weather_hazard', surface: 'now', ownerCore: 'Weather/Event', status: 'adapter_ready', demoRequired: true, description: 'Verified rain, flood, wind, snow, ice or frost hazard relevant to the user.' },
