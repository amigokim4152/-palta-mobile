...
> palta-app-prep-v3-8@1.8.0 verify
> npm run typecheck && npm test && npm run check:independence


> palta-app-prep-v3-8@1.8.0 typecheck
> tsc --noEmit


> palta-app-prep-v3-8@1.8.0 test
> npm run build && node dist/tests/run-tests.js


> palta-app-prep-v3-8@1.8.0 build
> tsc
...
> palta-app-prep-v3-8@1.8.0 check:independence
...
```text
PASS: mobile overlay syntax (63 files)
...
NOT VERIFIED:
- installed Expo/React Native type resolution
- actual device font-scale behavior
- final spacing/color tuning on screen
- TTS
- haptics
