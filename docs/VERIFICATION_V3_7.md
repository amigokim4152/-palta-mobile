# Verification v3.7 — 2026-09-16

Core verify exit: 0

```text

> palta-app-prep-v3-7@1.7.0 verify
> npm run typecheck && npm test && npm run check:independence


> palta-app-prep-v3-7@1.7.0 typecheck
> tsc --noEmit


> palta-app-prep-v3-7@1.7.0 test
> npm run build && node dist/tests/run-tests.js


> palta-app-prep-v3-7@1.7.0 build
> tsc
...
> palta-app-prep-v3-7@1.7.0 check:independence
...
- presentation priority rules
- focus layout rules
- reading contracts
- haptic intent semantics

NOT VERIFIED:
- real iOS Dynamic Type
- real Android font scaling
- TalkBack / VoiceOver on device
- physical haptic quality by device
- native TTS quality and language switching
